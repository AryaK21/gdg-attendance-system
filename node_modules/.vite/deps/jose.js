...
var fromPKCS8 = (pem, alg, options) => {
  ...
  let opts = options;
  if ((_a3 = alg == null ? void 0 : alg.startsWith) == null ? void 0 : _a3.call(alg, "ECDH-ES")) {
    opts || (opts = {});
...
async function flattenedDecrypt(jwe, key, options) {
  ...
  validateCrit(JWEInvalid, /* @__PURE__ */ new Map(), options == null ? void 0 : options.crit, parsedProt, joseHeader);
...
var FlattenedEncrypt = class {
  ...
  async encrypt(key, options) {
    ...
    if (!isDisjoint(__privateGet(this, _protectedHeader), __privateGet(this, _unprotectedHeader), __privateGet(this, _sharedUnprotectedHeader))) {
    ...
    validateCrit(JWEInvalid, /* @__PURE__ */ new Map(), options == null ? void 0 : options.crit, __privateGet(this, _protectedHeader), joseHeader);
    if (joseHeader.zip !== void 0) {
      throw new JOSENotSupported('JWE "zip" (Compression Algorithm) Header Parameter is not supported.');
    }
    const { alg, enc } = joseHeader;
    ...
    let cek;
    {
      let parameters;
      const k = await normalizeKey(key, alg);
      ({ cek, encryptedKey, parameters } = await encryptKeyManagement(alg, enc, k, __privateGet(this, _cek), __privateGet(this, _keyManagementParameters)));
      if (parameters) {
    ...
    let aadMember;
    if (__privateGet(this, _protectedHeader)) {
      protectedHeaderS = encode2(JSON.stringify(__privateGet(this, _protectedHeader)));
    ...
    if (__privateGet(this, _aad)) {
      aadMember = encode2(__privateGet(this, _aad));
      const aadMemberBytes = encode(aadMember);
      additionalData = concat(protectedHeaderB, encode("."), aadMemberBytes);
    } else {
      additionalData = protectedHeaderB;
    }
    const { ciphertext, tag: tag2, iv } = await encrypt2(enc, __privateGet(this, _plaintext), cek, __privateGet(this, _iv), additionalData);
    const jwe = {
...
var IndividualRecipient = class {
  constructor(enc, key, options) {
    ...
    __publicField(this, "keyManagementParameters");
...
var GeneralEncrypt = class {
  ...
  async encrypt() {
    ...
    for (let i = 0; i < __privateGet(this, _recipients).length; i++) {
      ...
      if (!isDisjoint(__privateGet(this, _protectedHeader2), __privateGet(this, _unprotectedHeader2), recipient.unprotectedHeader)) {
        throw new JWEInvalid("JWE Protected, JWE Shared Unprotected and JWE Per-Recipient Header Parameter names must be disjoint");
      }
      const joseHeader = {
      ...
      validateCrit(JWEInvalid, /* @__PURE__ */ new Map(), recipient.options.crit, __privateGet(this, _protectedHeader2), joseHeader);
      if (joseHeader.zip !== void 0) {
        throw new JOSENotSupported('JWE "zip" (Compression Algorithm) Header Parameter is not supported.');
      }
    }
...
var FlattenedSign = class {
  ...
  async sign(key, options) {
    ...
    if (!isDisjoint(__privateGet(this, _protectedHeader3), __privateGet(this, _unprotectedHeader3))) {
      throw new JWSInvalid("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
    }
    const joseHeader = {
    ...
    const extensions = validateCrit(JWSInvalid, /* @__PURE__ */ new Map([["b64", true]]), options == null ? void 0 : options.crit, __privateGet(this, _protectedHeader3), joseHeader);
    let b64 = true;
    if (extensions.has("b64")) {
    ...
    if (__privateGet(this, _protectedHeader3)) {
      protectedHeaderString = encode2(JSON.stringify(__privateGet(this, _protectedHeader3)));
...
var UnsecuredJWT = class {
  ...
  encode() {
    ...
    const payload = encode2(__privateGet(this, _jwt3).data());
